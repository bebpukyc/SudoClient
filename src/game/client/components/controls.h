...
public:
	...
	// steal: silent-aim channel (shared by BAF / laser unfreeze). Set by a
	// component before SnapInput, consumed (and reset) at the end of SnapInput
	// right before sending to the server.
