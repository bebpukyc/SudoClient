...
public:
	...
	// BestClient port: matches 2.2.2's no-arg GetTuning(), returns the character's own core tuning.
	using CEntity::GetTuning;
	CTuningParams *GetTuning() { return &m_Core.m_Tuning; }
