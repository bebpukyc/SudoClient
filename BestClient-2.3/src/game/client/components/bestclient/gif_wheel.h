...
#ifndef GAME_CLIENT_COMPONENTS_BESTCLIENT_GIF_WHEEL_H
#define GAME_CLIENT_COMPONENTS_BESTCLIENT_GIF_WHEEL_H
...
#endif // GAME_CLIENT_COMPONENTS_BESTCLIENT_GIF_WHEEL_H
