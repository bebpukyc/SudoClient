...
// НЕ БУМПАТЬ: тег семейный, а не версионный — обязан оставаться константой,
// иначе sudo перестанет матчиться между старыми и будущими сборками.
#define SUDOCLIENT_VERSION "2.3-sudo"
