...
protected:
	...
	// found in menus_prikoli.cpp
	void RenderSettingsSteal(CUIRect MainView);
	void RenderSettingsStealAimbot(CUIRect MainView);
	void RenderSettingsStealVisuals(CUIRect MainView);
	void RenderSettingsStealOther(CUIRect MainView);
	void RenderSettingsStealBinds(CUIRect MainView);

	// found in components/botsymona/menus_bot.cpp
	void RenderSettingsBot(CUIRect MainView);
	void RenderSettingsBotBehaviour(CUIRect MainView);
	void RenderSettingsBotWar(CUIRect MainView);
	void RenderSettingsBotAi(CUIRect MainView);
